...
public class ChatWithDocumentsExamples {
    ...
    static class IfYouNeedSimplicity {
        ...
        public static void main(String[] args) throws Exception {
            ...
            Document document = loadDocument(toPath("D:\\workspace1\\LangChain-Demo\\src\\main\\resources\\Girl_Story.docx"), new TextDocumentParser());
            ...
            String answer = chain.execute("Author's Name?");
